...
//require(NPCMS_MEMBERSHIP_PATH . './aarc_db.php');
/**
 *
...
jQuery(document).ready(function (){
    ...
    function npcms_membership_login_shortcode_body( $attr, $content = null ) {
        ...
        if ($m->isUserLoggedIn()) {
            ...
            $success = '<p>You have logged in successfully. <br>
			<a href="http://ethics.aarc.org/aarctest/california-modules">View Course</a> or <a href="?npcms_logout=true">Click here</a> to log out</p>' ;
        ...
        if (isset($_POST['Username']) && isset($_POST['Password'])) {
            ...
            if (!$response) {
				...
				/*if ( !user_name_exists( $user_name ) == false ) {
					//Create User id
					wp_create_user( $_POST['Username'], $_POST['Password'], 'wordpress@aarc.org' );
					//Assign User to course
					ThemexCourse::subscribeUser(2128, $user_name, true);
				}*/
