			...
			<form id="quiz_form" action="<?php the_permalink(); ?>" method="POST">				
				...
				<div class="quiz-question">
					<div class="question-title">
						...
						<h4 class="nomargin"><?php echo $question['question']; ?></h4>
					</div>				
					<ul>
						<?php
						...
						foreach($question['answers'] as $answer_key=>$answer) {
							...
							?>
							<li>
								<input type="checkbox" id="answer_<?php echo $question_key.'_'.$answer_key; ?>" name="answer_<?php echo $question_key.'_'.$answer_key; ?>" value="<?php echo $answer; ?>" <?php if(isset($_POST['answer_'.$question_key.'_'.$answer_key])) { ?>checked="checked"<?php } ?> /><label for="answer_<?php echo $question_key.'_'.$answer_key; ?>"><?php echo $answer; ?></label>
							</li>
							<?php 
							}
						} 
