...
<div class="course-preview <?php echo ThemexCourse::$data['course']['status']; ?>-course <?php if(ThemexCourse::$data['course']['progress'] == 100) { ?>complete <?php } else { ?>incomplete <?php } ?>">
