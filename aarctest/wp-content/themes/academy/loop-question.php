<li id="comment-<?php echo $comment->comment_ID; ?>">
	...
	<div class="question-title toggle-title">
		<div class="question-replies"><?php echo ThemexCourse::questionsNumber($comment->comment_ID); ?></div>
		<h4 class="nomargin"><?php echo get_comment_meta(get_comment_ID(), 'title', true); ?>&nbsp;</h4>										
	</div>
	<?php } ?>
	<div class="question-content toggle-content">
		...
		<div class="question-text">
			<header class="question-header hidden-wrap">
				...
				<time class="question-time left" datetime="<?php comment_time('Y-m-d'); ?>"><?php comment_time($GLOBALS['date_format']); ?></time>
