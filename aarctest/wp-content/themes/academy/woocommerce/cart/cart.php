		...
		<tr>
			<td colspan="6" class="actions">
				...
				<?php if ( $woocommerce->cart->coupons_enabled() ) { ?>
					<div class="coupon">
						<input name="coupon_code" class="input-text left" id="coupon_code" value="" placeholder="<?php _e( 'Coupon', 'woocommerce' ); ?>" /> 
						<input type="submit" class="button secondary left" name="apply_coupon" value="<?php _e( 'Apply Coupon', 'woocommerce' ); ?>" />
						<?php do_action('woocommerce_cart_coupon'); ?>
					</div>
				<?php } ?>
				<input type="submit" class="button secondary" name="update_cart" value="<?php _e( 'Update Cart', 'woocommerce' ); ?>" /> <input type="submit" class="checkout-button button alt" name="proceed" value="<?php _e( 'Proceed to Checkout &rarr;', 'woocommerce' ); ?>" />
