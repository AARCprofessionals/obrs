...
<form class="shipping_calculator left" action="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" method="post">
	<h2><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></h2>
	<section class="shipping-form formatted-form">
		...
		<div class="clear"></div>
		<p><button type="submit" name="calc_shipping" value="1" class="button secondary"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
