...
<div class="order_details column fivecol">
	<?php if (in_array($order->status, array('failed'))) : ?>
		<h3><?php _e('Failure in Processing the Payment.', 'woocommerce'); ?></h3>
	...
	<?php else : ?>
		<h3><?php _e('Thank you. Your order has been received.', 'woocommerce'); ?></h3>		
	<?php endif; ?>
	<ul class="order_details">
		<li class="order">
			<strong><?php _e('Order:', 'woocommerce'); ?></strong>
