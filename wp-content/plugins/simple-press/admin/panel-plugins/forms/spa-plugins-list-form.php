...
Simple:Press
Admin plugins list
$LastChangedDate: 2014-03-11 04:27:21 -0700 (Tue, 11 Mar 2014) $
$Rev: 11157 $
*/
...
?>
	...
	<table class="wp-list-table widefat plugins">
        <thead>
		<tr>
			<th id='cb-select-all-1' class='manage-column column-cb check-column' scope='column'>
				<input type="checkbox" />
			</th>
			<th class='checkIcon'>
			</th>
        ...
        <tfoot>
		<tr>
			<th id='cb-select-all-2' class='manage-column column-cb check-column' scope='column'>
				<input type="checkbox" />
			</th>
			<th>
			</th>
...
?>
        	<tr class='<?php echo $rowClass; ?>'>
        		<th class='check-column' scope='row'>
					<input id="checkbox_<?php echo rand(1, 9999999999); ?>" type="checkbox" value="<?php echo $plugin_file; ?>" name="checked[]" <?php echo($disabled); ?>/>
				</th>
				<td class='checkIcon'>
                	<?php echo $icon; ?>
				</td>
				...
				<tr class='<?php echo $rowClass; ?>'>
					<td colspan="4">
						<div class="sfoptionerror">
							<?php echo sprintf(spa_text('The folder name of this plugin has become corrupted - probably due to multiple downloads. Please remove the %s at the end of the folder name'), '<strong>'.substr($path[0], -2).'</strong>'); ?>
						</div>
					</td>
				</tr>
<?php
