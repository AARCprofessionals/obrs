...
$LastChangedDate: 2014-02-20 14:20:13 -0800 (Thu, 20 Feb 2014) $
$Rev: 11085 $
*/
...
function spa_save_forums_create_forum() {
	...
	$sql = 'INSERT INTO '.SFFORUMS.' (forum_name, forum_slug, forum_desc, group_id, forum_status, forum_seq, forum_rss_private, forum_icon, forum_icon_new, topic_icon, topic_icon_new, topic_icon_locked, parent, forum_message, keywords) ';
	$sql.= "VALUES ('".$forumdata['forum_name']."', '".$forumslug."', '".$forumdata['forum_desc']."', ".$forumdata['group_id'].", ".$forumdata['forum_status'].", ".$forumdata['forum_seq'].", ".$forumdata['forum_rss_private'].", '".$forumdata['forum_icon']."', '".$forumdata['forum_icon_new']."', '".$forumdata['topic_icon']."', '".$forumdata['topic_icon_new']."', '".$forumdata['topic_icon_locked']."', ".$parentdata.", '".$forumdata['forum_message']."', '".$forumdata['forum_keywords']."');";
...
function spa_save_forums_order() {
    ...
    foreach ($list['forum'] as $id => $parent) {
        ...
        if (isset($list['group'][$parent])) { # group
            ...
            $children = serialize(array_keys($list['forum'], $parent));
