...
?>
		...
		<input type="button" class="button-primary" onclick="javascript:jQuery('#forum-<?php echo $forum_id; ?>').html('');jQuery('#forumrow-<?php echo $forum_id; ?>').removeClass('inForm');" id="sfforumdisable<?php echo $forum_id; ?>" name="disableforumcancel<?php echo $forum_id; ?>" value="<?php spa_etext('Cancel'); ?>" />
		</div>
	</form>
