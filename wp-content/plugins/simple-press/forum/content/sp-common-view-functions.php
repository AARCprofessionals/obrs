...
$LastChangedDate: 2014-04-14 12:59:45 -0700 (Mon, 14 Apr 2014) $
$Rev: 11292 $
*/
...
function sp_MobileMenuEnd($args='') {
	...
	$out.= "</ul>\n";
	$out.= "<script>jQuery(document).ready(function() { jQuery(function () { jQuery('#$listTagId').spMobileMenu({sclass:'$tagClass'}); }); });</script>\n";
...
function sp_OpenCloseControl($args='', $toolTipOpen='', $toolTipClose='') {
	...
	if (isset($_COOKIE[$targetId])) $default = $_COOKIE[$targetId];
	...
	$out = "<div id='$tagId' onclick='spjOpenCloseSection(\"$targetId\", \"$tagId\", \"$tagClass\", \"$openIcon\", \"$closeIcon\", \"$toolTipOpen\", \"$toolTipClose\");'>\n";
	$out.= "<img class='$tagClass vtip' title='$tooltip' src='$icon' alt='' />\n";
	$out.= "</div>\n";
