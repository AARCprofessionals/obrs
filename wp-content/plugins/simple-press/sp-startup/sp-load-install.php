...
Simple:Press
Installer/Upgrader
$LastChangedDate: 2014-03-16 01:41:22 -0700 (Sun, 16 Mar 2014) $
$Rev: 11166 $
*/
...
function sp_upgrade_required() {
	...
	<div class="wrap"><br />
		...
		<div class="showmessage">
		<img class="stayleft" src="<?php echo SFCOMMONIMAGES; ?>sp-small-megaphone.png" alt="" title="" />
		<h2><?php echo sprintf(spa_text('Upgrade Simple:Press From Version %s to %s'), sp_get_option('sfversion'), SPVERSION); ?><br />
...
function sp_version_checks() {
	...
	if ($xml) {
	   ...
	   $message.= '<h2>'.spa_text('Unable to communicate with SP servers for version requirements. Please try again in few minutes.').'</h2>';
    }
