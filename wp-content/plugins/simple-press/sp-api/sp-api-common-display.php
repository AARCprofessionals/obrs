...
# ------------------------------------------------------------------
function sp_build_name_display($userid, $username, $linkOveride=false) {
	...
	if ($userid) {
		...
		if (sp_get_auth('view_profiles') && ($profile['namelink'] == 2 || $linkOveride == true)) {
            # link to profile
