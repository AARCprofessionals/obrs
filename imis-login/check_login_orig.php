...
function successURL() { //2. do this for iMIS logged in users
...
//if user id does not exist in wpdb - wp_create_user then auto-login

//else auto_login() - functions.php
//auto_login('user');
